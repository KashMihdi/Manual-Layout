...
final class ManualLayout: UIViewController {
    ...
    private func setConstraints() {
        NSLayoutConstraint.activate([
            ...
            mainView.heightAnchor.constraint(equalTo: view.heightAnchor, multiplier: 1/3)
        ])
        
        NSLayoutConstraint.activate([
            stackConstantLabel.topAnchor.constraint(equalTo: mainView.bottomAnchor, constant: 40),
            stackConstantLabel.leadingAnchor.constraint(equalTo: view.leadingAnchor, constant: 16)
            
        ])
        
        NSLayoutConstraint.activate([
            stackLabel.topAnchor.constraint(equalTo: mainView.bottomAnchor, constant: 40),
            stackLabel.leadingAnchor.constraint(equalTo: stackConstantLabel.trailingAnchor, constant: 16)
        ])
        
        NSLayoutConstraint.activate([
            stackSlider.topAnchor.constraint(equalTo: mainView.bottomAnchor, constant: 34),
            stackSlider.leadingAnchor.constraint(equalTo: stackLabel.trailingAnchor, constant: 16)
        ])
        
        NSLayoutConstraint.activate([
            stackTF.topAnchor.constraint(equalTo: mainView.bottomAnchor, constant: 37),
            stackTF.leadingAnchor.constraint(equalTo: stackSlider.trailingAnchor, constant: 16),
            stackTF.trailingAnchor.constraint(equalTo: view.trailingAnchor, constant: -16)
        ])
    }
}
